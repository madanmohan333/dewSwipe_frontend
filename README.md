...
Body 
    ...
    - ssh -i "devSwipe-secret.pem" ubuntu@ec2-43-204-96-49.ap-south-1.compute.amazonaws.com
...
# Ngxinx config: 
        ...
        Domain name = devSwipe.com => 43.204.96.49

        Frontend = devSwipe.com
        Backend = devSwipe.com:7777 => devSwipe.com/api
...
# Addding a custom Domain name
    ...
    - DNS record: A devSwipe.in 43.204.96.49
